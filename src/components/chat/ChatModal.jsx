      ...
      {!selectedConversation ? (
        <div className="flex h-full items-center justify-center p-4">
          <div className="text-center">
            ...
            <p className="text-xl font-semibold text-slate-800 mb-2">{t('conversation.selectChat')}</p>
            <p className="text-sm text-slate-500 max-w-xs">{t('conversation.selectChatDescription')}</p>
          </div>
        </div>
      ) : (
        <>
            ...
            {loading && (
              <div className="flex justify-center items-center h-full">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-slate-500 font-medium">{t('status.loading') || 'Loading messages...'}</p>
                </div>
              </div>
            )}
